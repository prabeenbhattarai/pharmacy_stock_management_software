			...
			<tr>
				...
				<tr>
					<th class="text-center">
						<p><b>Deuti Medical & Pharmacy </b></p>
						<p>
							<b>Badaital, Bardiya</b>
						</p>
					</th>
				</tr>
				<tr>
				...
				<tr>
					<td class="clear">&nbsp;</td>
						...
						<tr>
							<th class="text-right wborder" colspan="3">Amount Paid</th>
							<th class="text-right wborder" ><?php echo number_format($amount_tendered,2) ?></th>
						</tr>
						<tr>
							<th class="text-right wborder" colspan="3">Change Return</th>
				...
				<tr>
                       <th class="text-center">
					<p><b>All Right Reserved | Printed by Deuti Pharmacy Software </b></p>
